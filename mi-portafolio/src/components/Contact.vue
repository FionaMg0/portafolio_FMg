...
<template>
  <div class="relative min-h-screen w-full overflow-hidden bg-queen-pink flex flex-col items-center justify-center p-4 md:p-8">
    ...
    <main class="glass w-full max-w-6xl rounded-[40px] shadow-2xl relative overflow-hidden flex flex-col min-h-[80vh]">
      ...
      <!-- Contact Content -->
      <div class="flex-1 flex flex-col lg:flex-row items-center justify-center p-6 md:p-20 pt-24 md:pt-32 gap-10 md:gap-16">
        
        <!-- Left Side: Large Typography -->
        <div class="flex-1 text-center lg:text-left lg:pr-12">
          <h2 class="text-4xl sm:text-6xl md:text-8xl font-serif italic text-jacarta leading-[0.9] mb-4 md:mb-8">
            Say hi & lets's work together!
          </h2>
        </div>

        <!-- Right Side: Contact Details -->
        <div class="flex-1 w-full max-w-sm space-y-8 md:space-y-10 text-center lg:text-left">
          
          <!-- Email Section -->
          <div class="space-y-2 md:space-y-4">
            <a :href="'mailto:' + email" class="text-base md:text-xl font-medium text-jacarta border-b border-jacarta/20 hover:border-middle-purple transition-all pb-1 inline-block">
              {{ email }}
            </a>
          </div>

          <!-- Social Links Grid -->
          <div class="flex flex-wrap justify-center lg:justify-start gap-x-8 md:gap-x-10 gap-y-4">
            <a :href="linkedin" target="_blank" class="flex items-center space-x-2 text-old-lavender hover:text-jacarta transition-colors group">
              ...
              <span class="text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em]">LinkedIn</span>
            </a>
            ...
            <a :href="github" target="_blank" class="flex items-center space-x-2 text-old-lavender hover:text-jacarta transition-colors group">
              ...
              <span class="text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em]">GitHub</span>
            </a>
          </div>
